...
class LeafletCardWithDeleteAction extends StatefulWidget {
  final LeafletData data;
  final Function onDelete;

  const LeafletCardWithDeleteAction({super.key, required this.data, required this.onDelete});

  @override
  State<LeafletCardWithDeleteAction> createState() => _LeafletCardWithDeleteActionState();
}

class _LeafletCardWithDeleteActionState extends State<LeafletCardWithDeleteAction> with TickerProviderStateMixin {
