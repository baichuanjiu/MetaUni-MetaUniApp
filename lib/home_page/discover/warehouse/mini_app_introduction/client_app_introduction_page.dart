...
import 'package:meta_uni_app/home_page/discover/warehouse/mini_app_introduction/models/mini_app_introduction.dart';
import 'package:meta_uni_app/home_page/discover/warehouse/mini_app_introduction/models/mini_app_review.dart';
import 'package:meta_uni_app/home_page/discover/warehouse/mini_app_introduction/reusable_components/guide/introduction_guide.dart';
...
class ClientAppIntroductionPage extends StatefulWidget {
  const ClientAppIntroductionPage({super.key});

  @override
  State<ClientAppIntroductionPage> createState() => _ClientAppIntroductionPageState();
}

class _ClientAppIntroductionPageState extends State<ClientAppIntroductionPage> with TickerProviderStateMixin {
  late MiniAppInformation miniAppInformation;
  late ClientApp clientApp;
  ...
  late int averageOfStars;
  late String averageOfRatingsString;
  late String trendingValueString;
  List<Widget> preview = [];
  ...
  _init() async {
    ...
    try {
      ...
      response = await dioModel.dio.get(
        '/metaUni/miniAppApi/miniApp/introduction/clientApp/${miniAppInformation.id}',
      ...
      switch (response.data['code']) {
        ...
        case 2:
          ...
          break;
        default:
          clientApp = ClientApp.fromJson(response.data['data']['clientApp']);
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  clientApp.minimumSupportVersion,
                                  maxLines: 1,
                                  overflow: TextOverflow.ellipsis,
                                  style: Theme.of(context).textTheme.labelLarge?.apply(color: Theme.of(context).colorScheme.outline),
                                ),
